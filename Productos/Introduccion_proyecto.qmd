...
datos6|>
  ...
  labs(title="Evolución de tasas de crecimiento natural en regiones de Corea del Sur en 2000-2022",x = NULL,y = "Valor tasa",subtitle = "Comparación de  tasas en las regiones Seoul, Busan, Incheon, Daegu, Daejeon",caption = "Fuente: elaboración propia a partir de datos disponibles en Kaggle")+
  scale_x_continuous(breaks = seq("2000", "2022", by = 2)) +
  ylim(c(-10,12)) + 
  geom_line( size = 1)+
  geom_point(size = 2) +
